...
class User {
  static async createUser(userData) {
    const { firstName, lastName, email, phoneNumber, isPrimeUser, isActive, password } = userData;
    const [result] = await db.query(`
            INSERT INTO users (firstName, lastName, email, phoneNumber, isPrimeUser, isActive, password)
            VALUES (?, ?, ?, ?, ?, ?, ?)`,
      [firstName, lastName, email, phoneNumber, isPrimeUser, isActive, password]);
